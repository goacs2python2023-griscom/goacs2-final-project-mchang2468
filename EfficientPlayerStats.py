...
for i in range(len(names)):
    ...
    a.text(i, 0, [names[i]], math.pi/2, text_font_size = "10pt", text_color = "black")
...
for i in range(len(names)):
    ...
    b.text(i, 0, [names[i]], math.pi/2, text_font_size = "10pt", text_color = "black")
...
for i in range(len(names)):
    ...
    c.text(i, 0, [names[i]], math.pi/2, text_font_size = "10pt", text_color = "black")
...
for i in range(len(names)):
    ...
    d.text(i, 0, [names[i]], math.pi/2, text_font_size = "10pt", text_color = "black")
...
for i in range(len(names)):
    ...
    e.text(i, 0, [names[i]], math.pi/2, text_font_size = "10pt", text_color = "black")
...
for i in range(len(names)):
    ...
    f.text(i, 0, [names[i]], math.pi/2, text_font_size = "10pt", text_color = "black")
